...
class Comment {
	...
	protected static $db_fields=array('id', 'photograph_id', 'author_id', 'created', 'author', 'body');
	...
	public static function make($photo_id, $author_id=0, $author="Anonymous", $body="") {
	...
	public static function find_author($author_id=0) {
		global $database;
		$result_array = self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE id={$author_id} LIMIT 1");
		return !empty($result_array) ? array_shift($result_array) : false;
	}
