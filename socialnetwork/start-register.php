...
<div class="login_main_heading"><img src="images/email.jpg" /></div>
<div class="login_main_formdiv">

<form name="cont" id="cont" method="post" onsubmit="return validateCont();" action="user-register.php">

<label class="register_heading">Start by entering your email:</label><br>

<input placeholder="Your email here" type="text" name="email" id="email" class="register_email" required />
<br>
